...
export const BUILDING_SPRITES = {
  ...
  jump: {
    map: [
      ...
      "..orRrRrRrRrRrRrRrRrRo..",
      "..oooooooooooooooooooo..",
      "..oaawwaawwaawwaawwaao..",
      "..oaawwaawwaawwaawwaao..",
      "..oooooooooooooooooooo..",
      "..obbbbbbbbbbbbbbbbbbo..",
      "..obowwwoboooooboowwob..",
      "..obowwwobodddobbowwob..",
      "..obowwwobodddobbowwob..",
      "..obooooobodddobboooob..",
      "..obbbbbbbodddobbbbbbo..",
      "..obbbbbbbodddobbbbbbo..",
      "..obbbbbbbodddobbbbbbo..",
      "..obbbbbbbodddobbbbbbo..",
    ...
    palette: { o: "#8c4a5e", r: "#ff9ec4", R: "#ffd45e", b: "#fff0f6", w: "#ffe0ee", d: "#ffb9d6", a: "#ffd45e", y: "#ffd45e", g: "#8fe3c9", k: "#8c4a5e" },
  },
  sing: {
    map: [
      "........................",
      ...
      "....oRRRRRRRRRRRRRRo....",
      "....oooooooooooooooo....",
      "..oawwawwawwawwawwawwo..",
      "..owwawwawwawwawwawwao..",
      "..oooooooooooooooooooo..",
      "..obbbbbbbbbbbbbbbbbbo..",
      "..obowwobbooooobbowwob..",
      "..obowwobodddddobowwob..",
      "..obooobodddddddobooob..",
      "..obbbbbodddddddobbbbb..",
      "..obbbbbodddddddobbbbb..",
      "..obbbbbodddddddobbbbb..",
      "..obbbbbodddddddobbbbb..",
      "..obbbbbodddddddobbbbb..",
    ...
    palette: { o: "#5b3a7a", r: "#b6a6f0", R: "#8b74e0", b: "#f3ecff", w: "#e0d4ff", d: "#c9b8ff", a: "#ffd45e", y: "#ffd45e", g: "#8fe3c9", k: "#5b3a7a" },
  },
  arcade: {
    map: [
      "........................",
    ...
    palette: { o: "#2f5b4a", r: "#8fe3c9", R: "#4ec9a6", b: "#eafff8", w: "#c9f2e4", d: "#a9e6d3", a: "#ffd45e", y: "#ffd45e", g: "#8fe3c9", k: "#2f5b4a" },
  },
  escape: {
    map: [
      "...........oo...........",
      ...
      ".....orrrrrrrrrrrro.....",
      "....orrrrrrrrrrrrrro....",
      "..owwwaaawwwaaawwwaaao..",
      "..oaaawwwaaawwwaaawwwo..",
      "..oooooooooooooooooooo..",
      "..obbbbbbbbbbbbbbbbbbo..",
      "..obowwobbooooobbowwob..",
      "..obowwobodddddobowwob..",
    ...
    palette: { o: "#6b4a2f", r: "#c9a06a", R: "#a9762f", b: "#fff3dc", w: "#ffdf9e", d: "#8c5a2f", a: "#e8874a", y: "#ffd45e", g: "#8fd8a8", k: "#6b4a2f" },
  },
  movie: {
    map: [
      "........................",
      ...
      "....oRRRRRRRRRRRRRRo....",
      "....oooooooooooooooo....",
      "..owawawawawawawawawao..",
      "..oawawawawawawawawawo..",
      "..oooooooooooooooooooo..",
      "..obbbbbbbbbbbbbbbbbbo..",
      "..oowwwwwwwwwwwooooooo..",
      "..owwwwwwwwwwwwodddddo..",
    ...
    palette: { o: "#3a3550", r: "#ffd45e", R: "#e8b400", b: "#efeaff", w: "#5b4a63", d: "#8b74e0", a: "#ffd45e", y: "#ffd45e", g: "#8fe3c9", k: "#3a3550" },
  },
  star: {
    map: [
      "...........yy...........",
    ...
    palette: { o: "#3a4a7a", r: "#a9b6f0", R: "#7f8fd6", b: "#eef2ff", w: "#bfe6ff", d: "#c9d4ff", a: "#ffd45e", y: "#ffd45e", g: "#8fe3c9", k: "#3a4a7a" },
  },
